...
class TestGeminiClientRouting(unittest.TestCase):
    def setUp(self):
    ...
    @patch("requests.post")
    def test_unlimited_surf_routing_by_gemini_api_key(self, mock_post):
        # Configure env variables to simulate ua_ prefix in GEMINI_API_KEY
        os.environ["GEMINI_API_KEY"] = "ua_testkey123"
    ...
    def test_unlimited_surf_routing_by_surf_api_key(self, mock_post):
        ...
        os.environ["GEMINI_API_KEY"] = "some_other_key"
    ...
    def test_openrouter_routing(self, mock_post):
        ...
        os.environ["GEMINI_API_KEY"] = "sk-or-testkey"
        os.environ.pop("SURF_API_KEY", None)
    ...
    def test_openai_routing(self, mock_post):
        ...
        os.environ["GEMINI_API_KEY"] = "sk-openaikey123"
        os.environ.pop("SURF_API_KEY", None)
